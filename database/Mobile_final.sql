...
If Not Exists(Select * from MergeFinals..para Where varname = 'P_MOBILECASHACC')
	...
	Values('P_MOBILECASHACC','C','130015','Mobile App Cash Collection Account') 
Go
...
If Exists(Select * From Sysobjects Where name = 'Sp_InsertMobiles')	
	Drop Procedure Sp_InsertMobiles
Go
...
If Exists(Select * From Sys.triggers Where name = 'Tr_MobileUpdate')
	Drop Trigger Tr_MobileUpdate
Go
